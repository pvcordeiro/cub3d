...
/*   Updated: 2025/06/15 21:41:22 by afpachec         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	targets_frame(t_character *character)
{
    ...
    wall_tar_data = wall_target(&cub3d()->game, character);
	if (wall_tar_data.entity)
		character->target_entity = wall_tar_data.entity;
	bill_tar_entity = billboard_target(&cub3d()->game, (t_entity *)character);
	if (bill_tar_entity)
