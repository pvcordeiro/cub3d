...
/*   Updated: 2025/05/18 10:43:20 by paude-so         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	loop(void)
{
	...
	if (cub3d()->game.hud.enabled)
		ftm_draw_rectangle(cub3d()->window.canvas, (t_coords){20, 20, 0}, (t_size){80, 40}, (t_ftm_rectangle){0x55000000, 0x55EFBF04, (t_size){2, 2}});
